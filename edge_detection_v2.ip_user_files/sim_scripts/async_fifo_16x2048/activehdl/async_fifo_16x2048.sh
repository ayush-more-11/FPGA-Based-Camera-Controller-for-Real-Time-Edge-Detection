...
#                script (type 'async_fifo_16x2048.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Ayush/Xilinx/edge_detection_v2/edge_detection_v2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
