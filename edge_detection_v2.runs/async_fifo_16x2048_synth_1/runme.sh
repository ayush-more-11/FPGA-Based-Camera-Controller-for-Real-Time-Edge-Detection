...
HD_PWD='D:/Ayush/Xilinx/edge_detection_v2/edge_detection_v2.runs/async_fifo_16x2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_fifo_16x2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source async_fifo_16x2048.tcl
